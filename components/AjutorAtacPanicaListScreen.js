                    ...
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        navigation.navigate("AjutorAtacPanicaVideo", {
                          ...
                          nowPlayingAccent: sub.icon_color || "#5cb85c",
                        })
                      }
                      activeOpacity={0.7}
                    >
                      <View style={[styles.iconWrap, { backgroundColor: sub.icon_bg || "#e8f7ee" }]}>
                        <Ionicons name={sub.icon_name || "play-outline"} size={20} color={sub.icon_color || "#5cb85c"} />
                      </View>
                      <Text style={styles.rowTitle}>{item.title}</Text>
                      <Ionicons name="chevron-forward" size={18} color="#c8d8e8" />
                    </TouchableOpacity>
