...
export default function AjutorAnxietateListScreen({ navigation }) {
  ...
  useEffect(() => {
    api.getCmsVideoSection('ajutor-anxietate')
      .then((data) => setCmsSubsections(data.subsections || []))
      .catch((err) => console.warn('[CMS] ajutor-anxietate:', err));
  }, []);
    ...
    <SafeAreaView style={styles.safeArea}>
      <LinearGradient colors={["#f6f7f8", "#f3f4f6", "#eef0f2"]} style={styles.background}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <Text style={styles.intro}>Alege un video de ajutor pentru momentele de anxietate</Text>
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    navigation.navigate("AjutorAnxietateVideo", {
                      ...
                      nowPlayingArtist: "Dan fost anxios · Ajutor anxietate",
