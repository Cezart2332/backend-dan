...
const styles = StyleSheet.create({
  ...
  notifyTitle: { fontSize: 15, fontWeight: '600', color: '#1c2b3a' },
  notifyDesc: { fontSize: 13, color: '#5b6a7a', marginTop: 4 },
  notifyHint: { fontSize: 12, color: '#24384e', marginTop: 8, fontWeight: '600' },
  testBtn: {
    marginTop: 14, borderRadius: 12, alignSelf: 'flex-start',
    backgroundColor: '#24384e', paddingVertical: 10, paddingHorizontal: 18,
  },
  ...
  footerText: { fontSize: 13, color: '#5b6a7a' },
});
