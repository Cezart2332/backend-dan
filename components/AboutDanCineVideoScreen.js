...
export default function AboutDanCineVideoScreen({ navigation }) {
  ...
  const source = { uri: `${BASE_URL}/api/media/${encodeURIComponent('about_dan_cine.mp4')}` };
    ...
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={["#f0f8ff", "#e6f3ff", "#ffffff"]} style={styles.gradient}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Cine sunt eu?</Text>
          <Text style={styles.subtitle}>Video de prezentare</Text>
        </View>
